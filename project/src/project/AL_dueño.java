...
public class AL_dueño {    
   ...
   public static boolean setDueño(int i,Dueño persona)throws IOException{
       if(i>=0&&i<=getNumeroRegistro()){
           if(persona.getTamaño()>tamaño_Arc)
           {System.out.println("\nTamaño registro excedido");}
           else{
           flujo.seek(i*tamaño_Arc);
           flujo.writeUTF(persona.getNombre_de_Usuario());
           
           flujo.writeInt(persona.getEdad());
           flujo.writeUTF(persona.getNombre_Real());
           flujo.writeUTF(persona.getFecha_de_Nacimiento());
           flujo.writeUTF(persona.getContraseña());
   ...
   public static void añadirDueño(Dueño persona)throws IOException{
   ...
   public static Dueño getDueño(int i) throws IOException
   {int Edad=0;
       ...
       if(i>=0&&i<=getNumeroRegistro())
       {
        ...
        flujo.seek(i*gettam());
         //System.out.println(i*getNumeroRegistro());
           ...
           //System.out.println("------------------------+");
           Dueño falso=new Dueño(flujo.readUTF(),flujo.readInt(),flujo.readUTF(),flujo.readUTF(),flujo.readUTF(),flujo.readUTF());
  ...
  // System.out.println("line 0");
   ...
   // System.out.println(gettam()+"--"+i);
      ...
      //  System.out.println(buscado.length()+" ++"+getNumeroRegistro()+"++");
        nombre=getDueño(i).getNombre_de_Usuario();
